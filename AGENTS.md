...
- Follow `rules/workflow/planning.md`
- Verify against `rules/workflow/verification.md`
- Close with a short retro in `plans/diary.md`

### Minimum standard

Before non-trivial execution:
1. understand context
2. write a short plan
3. verify real outcomes, not vibes
4. record decisions or dead ends that matter

### Files

- `state.md` — workspace task index
- `plans/SESSION_STATE.template.md` — task/session handoff template
- `plans/diary.md` — append-only work diary
- `rules/workflow/` — workflow rules
- `skills/` — local harness guides
